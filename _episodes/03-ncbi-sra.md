...
"PRJNA556841". To find these data you can follow the instructions below:** 

1. Notice that the paper references "PRJNA556841" as a "BioProject" at NCBI. If you go to the [NCBI website](https://www.ncbi.nlm.nih.gov/) and search for "SRR9952629" you will be shown a link to the "High Arctic lake sediments H2 (High Runoff)" BioProject. Here is the link to that database: [https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJNA556841](https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJNA556841)(../fig/03_paper_header.png). 

2. Once on the BioProject page, scroll down to the table under **"Project information:"**. *"[PRJNA556841](https://www.ncbi.nlm.nih.gov/bioproject?LinkName=sra_bioproject&from_uid=8831929)	SRA or Trace	Lake Hazen and Soil Metagenomes Summer 2017 (University of Ottawa...)"*. 

3. This will take you to a page with a table **"Project Data"** 
that has a link to the 8 SRA files for this subproject. 

4. Click on the number 
["8"](https://www.ncbi.nlm.nih.gov/sra?linkname=bioproject_sra_all&from_uid=556841) and it will take you to the SRA page for this subproject. 
![03_send_results.png]
...
1. Make sure you access the Tenaillon dataset from the provided link: [https://www.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA556841&o=acc_s%3Aa](https://www.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA556841&o=acc_s%3Aa). This is NCBI’s new cloud-based SRA interface. You will be presented with a page for the overall SRA accession SRR9952629 - this is a collection of all the experimental data. 
...
3. Notice on this page there are three sections. “Common Fields” “Select”, and “Found 8 Items”. Within “Found 8 Items”, click on the first Run Number (Column “run” Row “1”). 
...
> 
> Go to the [“old Run Selector” ](https://www.ncbi.nlm.nih.gov/Traces/study1/?acc=PRJNA556841&o=acc_s%3Aa) at the top of the page. Download your `SraRunTable.txt` file by clicking in **"RunInfo Table"**. 
> 
...
2. In the search bar, type in `SRR9952629`. Make sure there are no spaces after the accession number, and press search.
...
Data on NCBI SRA: [https://www.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA556841&o=acc_s%3Aa](https://www.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA556841&o=acc_s%3Aa)  
Data on EMBL-EBI ENA: [https://www.ebi.ac.uk/ena/data/view/PRJNA295606](https://www.ebi.ac.uk/ena/data/view/PRJNA556841)

...
In this lesson, we'll be using data from a study of experimental evolution using Lake Hazen Sediment and Soil Metagenomes (http://www.datacarpentry.org/organization-genomics/data/). In this study there are several types of files:
